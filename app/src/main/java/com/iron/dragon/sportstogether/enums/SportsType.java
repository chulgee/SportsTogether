...
/*    Badminton(0, R.string.badminton, R.drawable.badminton, R.color.sports_1),
    ...
    Table_tennis(2, R.string.table_tennis, R.dimen.sportstype2_text, R.color.sports_3, R.drawable.ic_table_tennisg, R.drawable.table_tennis_1208377_640),
    ...
    Baseball(4, R.string.baseball, R.dimen.sportstype4_text, R.color.sports_5, R.drawable.ic_baseball, R.drawable.hit_1407826_640),
